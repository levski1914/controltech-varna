      ...
      <div className="container-main grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <div className="section-card bg-gradient-to-br from-cyan-400/10 to-blue-500/10 p-8">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-white md:text-4xl">
            Инженерен подход и реално техническо мислене
          </h2>
        ...
        <div className="section-card p-8">
          <p className="text-lg leading-8 text-slate-300">
            Работим с ясен технически подход, подробна диагностика и разбираемо
            обяснение на проблема. Целта е клиентът да знае какво точно не е
            наред, какви са вариантите за ремонт и каква ще бъде крайната цена.
          </p>

          <p className="mt-5 text-lg leading-8 text-slate-300">
            Извършваме ремонт на лаптопи и компютри във Варна, включително
            профилактика, инсталация на Windows, SSD upgrade, смяна на
            компоненти и оптимизация при бавна работа, загряване или проблеми
            със стартиране.
          </p>
